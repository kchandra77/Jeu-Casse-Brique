...
if(choix=='connexion'){
  var connex ;
  connex= '<table align="center">';
  connex= connex + '<tr><td> Pseudo </td><td>  <input type="text" name="nom" /> <br> </td></tr>';
  connex= connex + '<tr><td> mdp </td><td>  <input type= "password" name= "password" /> <br> </td></tr>';
  connex= connex + '<tr><td> Confirmez mdp </td><td>  <input type= "Confirmpass" name= "Confirm password" /> <br> </td></tr>';
  connex= connex +'</table>';
  ...
  var inscrip ;
  inscrip= '<table align="center">';
  inscrip= inscrip + '<form action="mailto:ckurunchi@gmail.com" method="post">';
  inscrip= inscrip +   '<tr><td>  Nom </td><td>  <input type="text" name="nom" /> <br> </td></tr>';
  inscrip= inscrip + '<tr><td> Prénom </td><td>  <input type= "text" name="prénom" /> <br> </td></tr>';
  ...
  inscrip= inscrip + '<em id="Lettre"> 6 Lettres,</em><em id="Majuscule"> 1 Majuscule,</em><em id="Chiffre"> 3 chiffres,</em>';
  inscrip= inscrip +'<table>';
  ...
  inscrip= inscrip + '<input onclick="comparerMDP()" class="center" type="reset" value="Effacer" name="reset" /> <br>';
